...
function ChuongTrinhCongTacVien() {
    useEffect(() => {
        document.title = 'Chương trình cộng tác viên';
    });
            ...
            <div className="bg-[#f5f5f5] w-full py-4 mb-5">
                <div className="w-[83%] mx-auto">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-sm text-primary-yellow">Chương trình cộng tác viên</h1>
                    </div>
                </div>
            </div>
            <div className="w-[83%] mx-auto">
...
export default ChuongTrinhCongTacVien;
