...
function SanPhamNoiBat() {
    ...
    const [isThitHeo, setIsThitHeo] = useState(true);
    const [isThitBo, setIsThitBo] = useState(false);
        ...
        <div className="my-10">
            <div className="w-full bg-[#f7f7f7] rounded-xl flex">
                ...
                <div className="relative w-[300px]">
                    <img src={assets.productOutstandingBanner2} alt="" className="rounded-tr-xl rounded-br-xl" />
                    ...
                    <div className="absolute top-4 left-6">
                        ...
                        <p className="italic text-white underline my-2">Ưu đãi độc quyền - Giảm giá 10%</p>
                        <p className="text-white text-xl font-bold my-2">Mua sắm thoải mái chỉ từ 10.000 VNĐ</p>
